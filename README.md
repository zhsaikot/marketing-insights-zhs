...
```
cd existing_repo
git remote add origin https://gitlab.com/zhsaikot/marketing-insghts-zhs.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/zhsaikot/marketing-insghts-zhs/-/settings/integrations)
